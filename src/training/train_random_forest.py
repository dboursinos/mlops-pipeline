...
import pickle
import numpy as np
from sklearn.ensemble import RandomForestClassifier # NEW: Import RandomForestClassifier
...
max_depth_str = os.environ.get("MAX_DEPTH", "None") # 'None' or integer
...
with mlflow.start_run():
    mlflow.log_param("model_type", "RandomForestClassifier") # Log the specific model type
    mlflow.log_param("random_state", common_random_state)
    mlflow.log_param("cv", common_cv)

    # Log Random Forest specific hyperparameters
